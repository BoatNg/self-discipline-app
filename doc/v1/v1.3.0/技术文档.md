...
### 3. 前端代码实现
```env
VITE_SUPABASE_URL=https://laamssfbmnnadjrgomov.supabase.co
VITE_SUPABASE_ANON_KEY=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxhYW1zc2ZibW5uYWRqcmdvbW92Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Njg2OTI4ODAsImV4cCI6MjA4NDI2ODg4MH0.o3d_Qg5gHWKkPbnE0NcK66qjzsikUYq7AUttD6T58VQ
```
...
const supabaseUrl = import.meta.env.VITE_SUPABASE_URL // 从环境变量中获取
const supabaseKey = import.meta.env.VITE_SUPABASE_ANON_KEY // 从环境变量中获取
